...
# bot
bot_token = os.environ.get("TOKEN", "5645508309:AAEhrSlLZtKXEHhqDIAKYIQhHAVCnSAlVn8")
api_hash = os.environ.get("HASH", "5f7839feeba133497f24acfd005ef2ec") 
api_id = os.environ.get("ID", "7978114")
